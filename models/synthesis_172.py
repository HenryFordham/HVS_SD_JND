...
class Synthesis_net_172(nn.Module):
    '''
    Decode synthesis
    '''

    def __init__(self, out_channel_N=384):
        super(Synthesis_net_172, self).__init__()
        ...
        self.deconv3 = nn.ConvTranspose2d(out_channel_N, 3, 5, stride=2, padding=2, output_padding=1)
...
def build_model():
    ...
    analysis_net = Analysis_net_172()
    synthesis_net = Synthesis_net_172()
