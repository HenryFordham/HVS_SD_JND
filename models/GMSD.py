...
#     parser.add_argument('--ref', type=str, default='images/1_bridge.png')
#     parser.add_argument('--dist', type=str, default='images/0_finally_jndMap_39.48962603200921_37.32924825204841_37.820476295878464.png')
